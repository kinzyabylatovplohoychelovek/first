...
<?php
    ...
    <div class="menu">
        <li><a href="/index.php"><img src="assets/images/logo1.png" alt="logo"></a></li>
        <li><a href="/index.php">Главная</a></li>
        <li><a href="/categories.php">Репертуар</a></li>
        <li><a modal-open='formAuth'>Вход</a></li>
        <li><a modal-open='formReg'>Регистрация</a></li>
        <li><img id="specialButton" style="cursor:pointer;" src="https://lidrekon.ru/images/special.png" alt="ВЕРСИЯ ДЛЯ СЛАБОВИДЯЩИХ" title="ВЕРСИЯ ДЛЯ СЛАБОВИДЯЩИХ" /></li>
    </div>
